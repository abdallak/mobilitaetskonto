sap.ui.define(["sap/ui/core/mvc/Controller"], function (Controller) {
	...
	return Controller.extend("Mobilitaetskonto.Mobilitaetskonto.controller.Antrag", {
		onInit: function () {
			...
			var oDataModel = this.getView().getModel("antrag");
...
/*			var initState = {
			...
			var oModel = new sap.ui.model.odata.v2.ODataModel("/MOB_ANTRAG", initState);
		...
		onBeforeRendering: function() {
			...
			this.getView().byId("art").setSelectedKey("auszahlung");
			this.getView().byId("betrag").setValue("-");
			this.getView().byId("beschreibung").setValue("-");
